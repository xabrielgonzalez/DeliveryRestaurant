...
export const ProductosCarrusel = () => {
    return (
        <div className=" border-rose-700 border-solid border-[1px] bg-white rounded-md h-366 w-736">
            ...
            <h4 className="text-lg flex justify-center text-white bg-rose-700 mb-2 relative mt-[-10px] object-cover rounded-md">Pasta a la Bolognesa</h4>
            <div className="flex justify-center">
                <a 
                href="/"
                    className="bg-gray-200 border-solid border-[1px] text-rose-700 px-4 py-2 rounded m-2">
                    Ver mas
                </a>
            </div>
        </div>
